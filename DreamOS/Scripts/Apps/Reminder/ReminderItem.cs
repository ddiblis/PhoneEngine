...
namespace Michsky.DreamOS
{
    public class ReminderItem : MonoBehaviour
    {
        ...
        public GlobalTime.TimedEventType defaultType;
        public bool isOn;
