    ...
    public class ContextMenuSubMenu : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            for (int i = 0; i < cmContent.contexItems[subMenuIndex].subMenuItems.Count; ++i)
            {
                ...
                if (cmContent.contexItems[subMenuIndex].subMenuItems[i].itemType == ContextMenuContent.ContextItemType.Button && cmManager.contextButton != null)
                    selectedItem = cmManager.contextButton;
                else if (cmContent.contexItems[subMenuIndex].subMenuItems[i].itemType == ContextMenuContent.ContextItemType.Separator && cmManager.contextSeparator != null)
                ...
                if (nulLVariable == false)
                {
                    ...
                    if (cmContent.contexItems[subMenuIndex].subMenuItems[i].itemType == ContextMenuContent.ContextItemType.Button)
                    {
