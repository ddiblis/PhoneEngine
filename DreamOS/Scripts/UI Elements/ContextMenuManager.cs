...
namespace Michsky.DreamOS
{
    public class ContextMenuManager : MonoBehaviour
    {
        ...
        [HideInInspector] public BlurManager contextBlur;
        ...
        void Awake()
        {
            ...
            if (enableBlur == true) { contextBlur = contextAnimator.gameObject.GetComponent<BlurManager>(); }

            contextRect = contextAnimator.gameObject.GetComponent<RectTransform>();
            contentRect = contextContent.gameObject.GetComponent<RectTransform>();
        ...
        {
            if (enableBlur == true) { contextBlur.BlurOutAnim(); }
