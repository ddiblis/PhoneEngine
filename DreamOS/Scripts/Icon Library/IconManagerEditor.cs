...
namespace Michsky.DreamOS
{
    ...
    public class IconManagerEditor : Editor
    {
        ...
        void UpdateIconProperties()
        {
            ...
            {
                Undo.RegisterCompleteObjectUndo(imTarget.imageObject, imTarget.name);
                Undo.RegisterCompleteObjectUndo(imTarget, imTarget.name);
        ...
        {
            DreamOSEditorHandler.DrawComponentHeader(customSkin, "IM Top Header");
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    DreamOSEditorHandler.DrawProperty(iconLibrary, customSkin, "Icon Library");
                    ...
                    DreamOSEditorHandler.DrawHeader(customSkin, "Core Header", 10);
